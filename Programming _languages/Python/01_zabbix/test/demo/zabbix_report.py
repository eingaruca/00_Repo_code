...
ApiUrl = 'https://vmzabbix01/zabbix/api_jsonrpc.php'
...
def gettoken():
    ...
    auth = ZabbixAPI(url=ApiUrl, user='Admin', password='zabbix')
...
#            print(row)
        ...
        ######################################
        worksheet3 = workbook.add_worksheet("Graphics")
